/*
tunes.ts - Collection of example musical patterns for Strudel
...
// Type definition for tune patterns
export type TunePattern = string;

export const swimming: TunePattern = `// Koji Kondo - Swimming (Super Mario World)
stack(
  seq(
    "~",
    "~",
...
//.pianoroll({fold:1})
`;
export const giantSteps: TunePattern = `// John Coltrane - Giant Steps
...
export const zeldasRescue: TunePattern = `// Koji Kondo - Princess Zelda's Rescue
stack(
  // melody
...
export const caverave: TunePattern = `// "Caverave"
...
export const sampleDrums: TunePattern = `samples({
  bd: 'bd/BT0A0D0.wav',
  sn: 'sn/ST0T0S3.wav',
...
export const barryHarris: TunePattern = `// adapted from a Barry Harris excercise
"0,2,[7 6]"
  .add("<0 1 2 3 4 5 7 8>")
  .scale('C bebop major')
  .transpose("<0 1 2 1>/8")
  ...
  .color('#00B8D4')
`;
export const blippyRhodes: TunePattern = `// "Blippy Rhodes"
// @license CC BY-NC-SA 4.0 https://creativecommons.org/licenses/by-nc-sa/4.0/
// @by Felix Roos
...
export const wavyKalimba: TunePattern = `// "Wavy kalimba"
// @license CC BY-NC-SA 4.0 https://creativecommons.org/licenses/by-nc-sa/4.0/
// @by Felix Roos
...
export const festivalOfFingers: TunePattern = `// "Festival of fingers"
// @license CC BY-NC-SA 4.0 https://creativecommons.org/licenses/by-nc-sa/4.0/
// @by Felix Roos
...
export const undergroundPlumber: TunePattern = `// "Underground plumber"
// @license CC BY-NC-SA 4.0 https://creativecommons.org/licenses/by-nc-sa/4.0/
// @by Felix Roos
...
export const goodTimes: TunePattern = `// "Good times"
// @license CC BY-NC-SA 4.0 https://creativecommons.org/licenses/by-nc-sa/4.0/
// @by Felix Roos
...
export const echoPiano: TunePattern = `// "Echo piano"
// @license CC BY-NC-SA 4.0 https://creativecommons.org/licenses/by-nc-sa/4.0/
// @by Felix Roos
...
.piano()
.pianoroll()`;
export const sml1: TunePattern = `// Hirokazu Tanaka - World 1-1
stack(
  // melody
  note(\`<
...
export const randomBells: TunePattern = `// "Random bells"
// @license CC BY-NC-SA 4.0 https://creativecommons.org/licenses/by-nc-sa/4.0/
// @by Felix Roos
...
export const waa2: TunePattern = `// "Waa2"
// @license CC BY-NC-SA 4.0 https://creativecommons.org/licenses/by-nc-sa/4.0/
// @by Felix Roos
...
export const festivalOfFingers3: TunePattern = `// "Festival of fingers 3"
// @license CC BY-NC-SA 4.0 https://creativecommons.org/licenses/by-nc-sa/4.0/
// @by Felix Roos
...
export const meltingsubmarine: TunePattern = `// "Melting submarine"
// @license CC BY-NC-SA 4.0 https://creativecommons.org/licenses/by-nc-sa/4.0/
// @by Felix Roos
...
stack(
  ...
  .slow(3/2)`;
export const bassFuge: TunePattern = `// "Bass fuge"
// @license CC BY-NC-SA 4.0 https://creativecommons.org/licenses/by-nc-sa/4.0/
// @by Felix Roos
...
export const chop: TunePattern = `// "Chop"
// @license CC BY-NC-SA 4.0 https://creativecommons.org/licenses/by-nc-sa/4.0/
// @by Felix Roos
...
export const delay: TunePattern = `// "Delay"
// @license CC BY-NC-SA 4.0 https://creativecommons.org/licenses/by-nc-sa/4.0/
// @by Felix Roos
...
export const orbit: TunePattern = `// "Orbit"
// @license CC BY-NC-SA 4.0 https://creativecommons.org/licenses/by-nc-sa/4.0/
// @by Felix Roos
...
export const belldub: TunePattern = `// "Belldub"
// @license CC BY-NC-SA 4.0 https://creativecommons.org/licenses/by-nc-sa/4.0/
// @by Felix Roos
...
export const dinofunk: TunePattern = `// "Dinofunk"
// @license CC BY-NC-SA 4.0 https://creativecommons.org/licenses/by-nc-sa/4.0/
// @by Felix Roos
...
export const sampleDemo: TunePattern = `// "Sample demo"
// @license CC BY-NC-SA 4.0 https://creativecommons.org/licenses/by-nc-sa/4.0/
// @by Felix Roos
...
export const holyflute: TunePattern = `// "Holy flute"
// @license CC BY-NC-SA 4.0 https://creativecommons.org/licenses/by-nc-sa/4.0/
// @by Felix Roos
...
export const flatrave: TunePattern = `// "Flatrave"
// @license CC BY-NC-SA 4.0 https://creativecommons.org/licenses/by-nc-sa/4.0/
// @by Felix Roos
...
export const amensister: TunePattern = `// "Amensister"
// @license CC BY-NC-SA 4.0 https://creativecommons.org/licenses/by-nc-sa/4.0/
// @by Felix Roos
...
export const juxUndTollerei: TunePattern = `// "Jux und tollerei"
// @license CC BY-NC-SA 4.0 https://creativecommons.org/licenses/by-nc-sa/4.0/
// @by Felix Roos
...
export const csoundDemo: TunePattern = `// "CSound demo"
...
export const loungeSponge: TunePattern = `// "Lounge sponge"
// @license CC BY-NC-SA 4.0 https://creativecommons.org/licenses/by-nc-sa/4.0/
...
export const arpoon: TunePattern = `// "Arpoon"
// @license CC BY-NC-SA 4.0 https://creativecommons.org/licenses/by-nc-sa/4.0/
// @by Felix Roos
