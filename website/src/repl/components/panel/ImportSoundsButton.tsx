...
import { registerSamplesFromDB, uploadSamplesToDB, userSamplesDBConfig } from '../../idbutils';

interface ImportSoundsButtonProps {
  onComplete: () => void;
}

//choose a directory to locally import samples
export default function ImportSoundsButton({ onComplete }: ImportSoundsButtonProps) {
