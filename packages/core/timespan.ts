/*
timespan.ts - TimeSpan class for Strudel
...
export class TimeSpan {
  public begin: Fraction;
  public end: Fraction;

  constructor(begin: Fraction | number, end: Fraction | number) {
    this.begin = Fraction(begin);
    this.end = Fraction(end);
  }

  get spanCycles(): TimeSpan[] {
  ...
  withTime(func_time: (time: Fraction) => Fraction): TimeSpan {
